...
@section('contenido')
    <div class="md:flex md:justify-center ">
        <div class="md:w-1/2 bg-white shadow p-6">
            ...
            <form enctype="multipart/form-data" method="POST" class="mt-10 md:mt-0" action="{{route('perfil.store')}}">
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input accept=".jpg, .jpeg, .png" id="imagen" name="imagen" type="file" class="border p-3 w-full rounded-lg
                     " value="">
                </div>
